...
def test_resolve_deduplication_flow_keep_old_item() -> None:
    run_queue([
...
def test_resolve_deduplication_flow_replace_old_item() -> None:
    run_queue([
        call_enqueue("bank_statements", 1, iso_ts(delta_minutes=5)).expect(1),
        call_enqueue("bank_statements", 1, iso_ts(delta_minutes=0)).expect(1),
        call_enqueue("id_verification", 1, iso_ts(delta_minutes=5)).expect(2),
...
def test_resolve_deduplication_flow_replace_old_item_with_dependencies() -> None:
    run_queue([
        call_enqueue("credit_check", 1, iso_ts(delta_minutes=5)).expect(2),
        call_enqueue("bank_statements", 1, iso_ts(delta_minutes=7)).expect(3),
...
def test_resolve_deduplication_flow_replace_old_item_with_dependencies_changing_order() -> None:
    run_queue([
        call_enqueue("credit_check", 1, iso_ts(delta_minutes=7)).expect(2),
